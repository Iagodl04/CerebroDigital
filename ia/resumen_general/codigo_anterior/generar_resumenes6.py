...
"""
    ...
    try:
        ...
        # Una Raspberry Pi puede tardar bastante en generar texto.
        response = requests.post(OLLAMA_URL, json=data_request, timeout=600)
...
def procesar_dia(fecha):
    ...
    try:
        ...
        print("⚠️ No se pudo actualizar CSV automáticamente (usando datos existentes).")
